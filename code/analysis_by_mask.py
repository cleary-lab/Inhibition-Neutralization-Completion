...
if __name__ == '__main__':
	...
	plot_heatmap(virus_table, rmse, r2, '%s/heatmaps.png' % savepath_full)
	plot_violins(virus_table, rmse.values, 'RMSE', '%s/rmse_by_count.png' % savepath_full)
	plot_violins(virus_table, r2.values, 'R^2', '%s/r2_by_count.png' % savepath_full)
	virus_table.to_csv('%s/virus_table.csv' % savepath_full)
	rmse.to_csv('%s/rmse.csv' % savepath_full)
	r2.to_csv('%s/r2.csv' % savepath_full)
