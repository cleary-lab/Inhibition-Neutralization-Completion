...
python completion_job.py --dataset $DATASET --savepath $BASE/$OUT/AllFonnville --obs-frac $p --data-transform log10 --concat-option concat
...
python completion_job.py --dataset $DATASET --savepath $BASE/$OUT/AllFonnville_Human --obs-frac $p --data-transform log10 --concat-option concat
